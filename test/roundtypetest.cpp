...
int main()
{
 ...
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', 1u, 2u> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Round of -1/2 should be 0.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', 1u, 2u> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Round of 1/2 should be 1.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', 1u, 3u> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Round of -1/3 should be 0.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', 1u, 3u> > :: type, crap :: valueRatio<unsigned int, '+', 0u, 1u> >(), "Round of 1/3 should be 0.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', 2u, 3u> > :: type, crap :: valueRatio<unsigned int, '-', 1u, 1u> >(), "Round of -2/3 should be -1.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', 2u, 3u> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Round of 2/3 should be 1.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', 0u, 1u> > :: type, crap :: valueRatio<unsigned int, '+', 0u, 1u> >(), "Round of 0 should be 0.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', 0u, 1u> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Round of 0 should be 0.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', 1u, 1u> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Round of 1 should be 1.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', 1u, 1u> > :: type, crap :: valueRatio<unsigned int, '-', 1u, 1u> >(), "Round of -1 should be -1.");
 ...
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', 1u, std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '+', 0u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', 1u, std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '-', 1u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), 1u> > :: type, crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: roundType <crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), 1u> > :: type, crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), 1u> >(), "Should not fail on close to end of range values.");
