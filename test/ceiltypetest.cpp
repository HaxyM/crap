...
int main()
{
 ...
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '-', 1u, 2u> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Ceil of -1/2 should be 0.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '+', 1u, 2u> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Ceil of 1/2 should be 1.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '+', 0u, 1u> > :: type, crap :: valueRatio<unsigned int, '+', 0u, 1u> >(), "Ceil of 0 should be 0.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '-', 0u, 1u> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Ceil of 0 should be 0.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '+', 1u, 1u> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Ceil of 1 should be 1.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '-', 1u, 1u> > :: type, crap :: valueRatio<unsigned int, '-', 1u, 1u> >(), "Ceil of -1 should be -1.");
 ...
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '+', 1u, std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '-', 1u, std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), std :: numeric_limits <unsigned int> :: max()> > :: type, crap :: valueRatio<unsigned int, '-', 1u, 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), 1u> > :: type, crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), 1u> >(), "Should not fail on close to end of range values.");
 static_assert(std :: is_same<typename crap :: ceilType <crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), 1u> > :: type, crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), 1u> >(), "Should not fail on close to end of range values.");
