...
int main()
{
 ...
 static_assert( crap :: signbitType <crap :: valueRatio<unsigned int, '-', 1u, 2u> >(), "Signbit of -1/2 should be true.");
 static_assert(!crap :: signbitType <crap :: valueRatio<unsigned int, '+', 1u, 2u> >(), "Signbit of 1/2 should be false.");
 static_assert(!crap :: signbitType <crap :: valueRatio<unsigned int, '+', 0u, 1u> >(), "Signbit of 0 should be false.");
 static_assert( crap :: signbitType <crap :: valueRatio<unsigned int, '-', 0u, 1u> >(), "Signbit of -0 should be true.");
 static_assert(!crap :: signbitType <crap :: valueRatio<unsigned int, '+', 1u, 1u> >(), "Signbit of 1 should be false.");
 static_assert( crap :: signbitType <crap :: valueRatio<unsigned int, '-', 1u, 1u> >(), "Signbit of -1 should be true.");
 ...
 static_assert(!crap :: signbitType <crap :: valueRatio<unsigned int, '+', 1u, std :: numeric_limits <unsigned int> :: max()> >(), "Should not fail on close to end of range values.");
 static_assert( crap :: signbitType <crap :: valueRatio<unsigned int, '-', 1u, std :: numeric_limits <unsigned int> :: max()> >(), "Should not fail on close to end of range values.");
 static_assert(!crap :: signbitType <crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), std :: numeric_limits <unsigned int> :: max()> >(), "Should not fail on close to end of range values.");
 static_assert( crap :: signbitType <crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), std :: numeric_limits <unsigned int> :: max()> >(), "Should not fail on close to end of range values.");
 static_assert(!crap :: signbitType <crap :: valueRatio<unsigned int, '+', std :: numeric_limits <unsigned int> :: max(), 1u> >(), "Should not fail on close to end of range values.");
 static_assert( crap :: signbitType <crap :: valueRatio<unsigned int, '-', std :: numeric_limits <unsigned int> :: max(), 1u> >(), "Should not fail on close to end of range values.");
