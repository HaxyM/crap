...
inline constexpr crap :: secureAbsValue <Type, Values...> :: operator
typename crap :: secureAbsValue <Type, Values...> :: value_type () const noexcept
{
 return crap :: secreAbsValue <Type, Values...> :: value;
}
#if (crap_lib_integral_constant_callable >= 201304L)

template <class Type, Type ... Values>
inline constexpr typename crap :: secureAbsValue <Type, Values...> :: value_type
crap :: secreAbsValue <Type, Values...> :: operator () () const noexcept
{
 return crap :: secureAbsValue <Type, Values...> :: value;
}
#endif
#endif
