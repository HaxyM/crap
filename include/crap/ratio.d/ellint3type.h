...
#include "../cmath.d/ellint3type.h"
#include "../functional.d/lessvalue.h"
#include "../utility.d/typecast.h"

#ifndef CRAP_RATIO_ELLINT3TYPE
#define CRAP_RATIO_ELLINT3TYPE

namespace crap
{
 template <class Type, char SignK, Type NumeratorK, Type DenominatorK, char SignNu, Type NumeratorNu, Type DenominatorNu, char SignPhi, Type NumeratorPhi, Type DenominatorPhi>
	 struct ellint3Type<valueRatio<Type, SignK, NumeratorK, DenominatorK>, valueRatio<Type, SignNu, NumeratorNu, DenominatorNu>, valueRatio<Type, SignPhi, NumeratorPhi, DenominatorPhi> >
 {
  private:
  ...
  using sin2 = typename multipliesType <s, s> :: type;
  using ns2 = typename multipliesType <nu, sin2> :: type;
  using k2s2 = typename multipliesType <k, k, sin2> :: type;
  using const0 = typename zero <k2s2> :: type;
  ...
  using initX = typename minusType <const1, sin2> :: type;
  using initY = typename minusType <const1, k2s2> :: type;
  using initP = typename minusType <const1, ns2> :: type;
  ...
  using mu = typename dividesType <typename plusType <initX, initY, const1, initP, initP> :: type, const5> :: type;
  ...
  using initEps = typename maxType <lessType, initXnDev, initYnDev, initZnDev, initPnDev> :: type;
  ...
  using reduced = reduce<initX, initY, const1, initP, const0, const1, initEps, false>;
  ...
  public:
  using type = typename plusType <K, typename multipliesType <const1o3, ns2, s, Rj> :: type> :: type;
 };

 template <class Type, char SignK, Type NumeratorK, Type DenominatorK, char SignNu, Type NumeratorNu, Type DenominatorNu, char SignPhi, Type NumeratorPhi, Type DenominatorPhi>
	 template <class nX, class nY, class nZ, class nP, class Sigma, class p4, class eps>
 struct ellint3Type<valueRatio<Type, SignK, NumeratorK, DenominatorK>, valueRatio<Type, SignNu, NumeratorNu, DenominatorNu>, valueRatio<Type, SignPhi, NumeratorPhi, DenominatorPhi> > :: template
 ...
 template <class Type, char SignK, Type NumeratorK, Type DenominatorK, char SignNu, Type NumeratorNu, Type DenominatorNu, char SignPhi, Type NumeratorPhi, Type DenominatorPhi>
	 constexpr typename ellint3Type <valueRatio<Type, SignK, NumeratorK, DenominatorK>, valueRatio<Type, SignNu, NumeratorNu, DenominatorNu>, valueRatio<Type, SignPhi, NumeratorPhi, DenominatorPhi> > :: type
	 ellint_3(valueRatio<Type, SignK, NumeratorK, DenominatorK>, valueRatio<Type, SignNu, NumeratorNu, DenominatorNu>, valueRatio<Type, SignPhi, NumeratorPhi, DenominatorPhi>) noexcept;
}

template <class Type, char SignK, Type NumeratorK, Type DenominatorK, char SignNu, Type NumeratorNu, Type DenominatorNu, char SignPhi, Type NumeratorPhi, Type DenominatorPhi>
inline constexpr typename crap :: ellint3Type <crap :: valueRatio<Type, SignK, NumeratorK, DenominatorK>, crap :: valueRatio<Type, SignNu, NumeratorNu, DenominatorNu>, crap :: valueRatio<Type, SignPhi, NumeratorPhi, DenominatorPhi> > :: type
crap :: ellint_3(crap :: valueRatio<Type, SignK, NumeratorK, DenominatorK>, crap :: valueRatio<Type, SignNu, NumeratorNu, DenominatorNu>, crap :: valueRatio<Type, SignPhi, NumeratorPhi, DenominatorPhi>) noexcept
{
 return {};
}
#endif
